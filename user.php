...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into `staff_information`(name,date_of_joining,address,department,phone_number,gender,blood_group) values('$name','$date_of_joining','$address','$department','$phone_number','$gender','$blood_group')";
